...
INSERT INTO bookmakers (name, short_name, rules, min_loss_rub, sort_order) VALUES
  ('1xBet', '1X', 'Кэшбэк 5–10% от проигрышей. Для заявки нужен скриншот ставки и скрин личного кабинета.', 500, 1),
  ('Fonbet', 'FB', 'Кэшбэк 5–10% от проигрышей. Для заявки нужен скриншот ставки и история операций.', 500, 2),
  ('Betcity', 'BC', 'Кэшбэк 5–10% от проигрышей. Для заявки нужен скриншот из личного кабинета.', 500, 3),
  ('Melbet', 'MB', 'Кэшбэк 5–10% от проигрышей. Лимит 30 000 ₽ в месяц.', 500, 4),
